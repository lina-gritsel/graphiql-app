      ...
      <div className={styles.about}>
        ...
        <div className={styles.infoCard}>
          <p className={styles.text}>
            ...
            as server-side. The basic languages for Front-End Development are
        ...
        <div className={styles.infoCard}>
          <p className={styles.text}>
            ...
            TypeScript using the React framework and such a tool for managing
            data state and user interface as the Redux Toolkit. Also, various
            libraries were used during the creation, for example, Chakra UI for
            various components, i18next for translating the application into
            popular languages, sass and many other popular libraries.
          </p>
        </div>
